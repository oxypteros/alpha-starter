...
Alpha puts your words first by minimizing interface _distractions_ (UI) enhancing the _User Experience_ (UX) for **readers** and the creative experience for you, the **writer**.
{{< /text_snippet >}}
